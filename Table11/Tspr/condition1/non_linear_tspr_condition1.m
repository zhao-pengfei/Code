...
ci = [1.3241 1.4859 2.7714 5.3881 6.7900 5.8235];  % The unit remanufacturing cost
...
ma = [0.0261 0.0295 0.0613 0.1666 0.1910 0.2125]; % The carbon emissions of a remanufactured product
