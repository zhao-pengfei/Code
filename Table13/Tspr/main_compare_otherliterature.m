clc;clear;
n = zeros(1,4);m = zeros(1,4);ma = zeros(1,4);cu = zeros(1,4);F = zeros(1,4);t0 = zeros(1,4);
B = zeros(1,4);bvr = zeros(1,4);A = zeros(1,4);m2 = zeros(1,4);E1 = zeros(1,4);E = zeros(1,4);result = [];
...
e0 = [0.1 0.1 0.2 0.3];    % the FCE of a remanufactured product
...
for i = 1:length(Cr)
    ...
    t0(i)=dichotomyf(x1(i),x2(i),a,f(i),b,Cd(i),Cr(i),t);
