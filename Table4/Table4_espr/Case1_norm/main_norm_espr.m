...
a = 1.9;     % The coefficient of processing time
b = 6.6;     % The coefficient of processing time
c = 0;       % The coefficient of processing time
...
E1 = (Cp-Cn+Cv)*int((h-B)*g,h,0,B)+(Cp+Cv-bvr)*B-Cv*Ex+lambda*N; 
E = double(E1);
result = [t0;A;B;E;m1];
